...
class GameRoom {
  ...
  resetLevelState(levelIndex) {
    ...
    this.button = level.button ? { ...level.button, visible: levelIndex === 1, active: false } : null;
  }
  ...
  applyLevelInteractions(player) {
    ...
    if (this.button) {
      // El botón del nivel 1 está visible desde el inicio. Al pisarlo, se anima en cliente y activa la plataforma.
